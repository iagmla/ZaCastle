...
void akms26_mix1(struct akms26_state *state) {
    ...
    modadd26_block(state->S[1], 5, state->S[0]);
    modadd26_block(state->S[2], 5, state->S[1]);
    modadd26_block(state->S[3], 5, state->S[2]);
    modadd26_block(state->S[4], 5, state->S[3]);
}

void akms26_mix1_inv(struct akms26_state *state) {
    modsub26_block(state->S[4], 5, state->S[3]);
    modsub26_block(state->S[3], 5, state->S[2]);
    modsub26_block(state->S[2], 5, state->S[1]);
    modsub26_block(state->S[1], 5, state->S[0]);
